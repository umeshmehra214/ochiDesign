...
const LandingPage = () => {
  return (
    <div className='width-full h-screen bg-white pt-1'>
        ...
        <div className='border-t-[1px] border-zinc-800 mt-28 flex items-center justify-between py-3 px-20'>
          {["for public and private companies", "from the first pitch to IPO"].map((item, index)=>{
            return(
              <p key={index} className='text-md font-[10px] tracking-tight leading-none capitalize'>{item}</p>
            )
          })}
          <div className='start flex items-center justify-between gap-4'>
